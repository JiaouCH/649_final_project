...
######################################################################################################################
    ...
    st.markdown("Addressing the high rates of depression in the US is crucial, but there's still a significant gap in treatment. According to the National Institute of Mental Health, in 2021, **only around 61% of adults and 40.6% of adolescents with major depressive episodes got help in the past year**. Many others with milder forms of depression likely didn't get treated either. Seeking professional help is often the most effective way to combat depression and prevent it from worsening. It's important not to stop taking medication or adjust doses without consulting a doctor. Adopting a healthy lifestyle can also support mental well-being, as physical health and mental health are closely connected. Being around supportive people can provide comfort, and it's crucial to stay persistent in finding the right treatment. While it's not easy, having confidence in oneself can make a world of difference in overcoming depression.")
    ...
    st.markdown("[6]. 'Depressive disorders [dataset].' 'Global Burden of Disease Study (2019) – processed by Our World in Data.' *IHME*, https://ghdx.healthdata.org/gbd-2019/data-input-sources. [Apr. 21, 2024]")
